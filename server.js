...
passport.use(new FacebookStrategy({
    ...
    callbackURL: "http://powerful-ridge-1197.herokuapp.com/auth/facebook/callback"
  },
...
passport.use(new TwitterStrategy({
    ...
    callbackURL: "http://powerful-ridge-1197.herokuapp.com/auth/twitter/callback"
  },
...
passport.use(new GoogleStrategy({
    ...
    callbackURL: "http://powerful-ridge-1197.herokuapp.com/auth/google/callback",
...
app.get('/auth/facebook/callback', 
  passport.authenticate('facebook', { successRedirect: 'http://vast-headland-2092.herokuapp.com/#chat',
                                      failureRedirect: 'http://vast-headland-2092.herokuapp.com/#login' }));
...
app.get('/auth/twitter/callback', 
  passport.authenticate('twitter', { successRedirect: 'http://vast-headland-2092.herokuapp.com/#chat',
                                      failureRedirect: 'http://vast-headland-2092.herokuapp.com/#login' }));
...
app.get('/auth/google/callback', 
  passport.authenticate('google', { successRedirect: 'http://vast-headland-2092.herokuapp.com/#chat',
                                    failureRedirect: 'http://vast-headland-2092.herokuapp.com/#login' }));
...
app.get('/loggedin', function(req, res) { 
  ...
  res.set({
    'Access-Control-Allow-Origin': 'http://vast-headland-2092.herokuapp.com',
